...
typedef enum {
    NRF_PIPE0_ADDR = NRF_REG_RX_ADDR_P0,
    NRF_PIPE1_ADDR = NRF_REG_RX_ADDR_P1,
    NRF_PIPE2_ADDR = NRF_REG_RX_ADDR_P2,
    NRF_PIPE3_ADDR = NRF_REG_RX_ADDR_P3,
    NRF_PIPE4_ADDR = NRF_REG_RX_ADDR_P4,
    NRF_PIPE5_ADDR = NRF_REG_RX_ADDR_P5,
} nrf_rx_pipe_address;

typedef enum {
    NRF_PIPE0_PAYLOAD_SIZE = NRF_REG_RX_PW_P0,
    NRF_PIPE1_PAYLOAD_SIZE = NRF_REG_RX_PW_P1,
    NRF_PIPE2_PAYLOAD_SIZE = NRF_REG_RX_PW_P2,
    NRF_PIPE3_PAYLOAD_SIZE = NRF_REG_RX_PW_P3,
    NRF_PIPE4_PAYLOAD_SIZE = NRF_REG_RX_PW_P4,
    NRF_PIPE5_PAYLOAD_SIZE = NRF_REG_RX_PW_P5,
